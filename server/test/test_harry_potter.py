...
# 统计信息
print("\n=== 统计信息 ===\n")
period_count = sum(1 for s in result['sentences'] if s[-1] == '.')
exclaim_count = sum(1 for s in result['sentences'] if s[-1] == '!')
question_count = sum(1 for s in result['sentences'] if s[-1] == '?')
print(f"句号结尾: {period_count}")
print(f"感叹号结尾: {exclaim_count}")
print(f"问号结尾: {question_count}")
